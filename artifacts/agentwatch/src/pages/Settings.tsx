      ...
      <div className="max-w-2xl space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 bg-white/3 border border-white/8 rounded-xl px-4 py-3">
                <span className="text-white/50 text-sm">Hobby</span>
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <div className="text-white font-bold text-sm">Deep Analysis</div>
              <div className="text-white/30 text-xs">Use your own LLM key to get AI-powered root cause analysis</div>
            </div>
            <button
          ...
          {deepAnalysis && (
            ...
            >
              <div>
                <label className="block text-white/40 text-xs font-medium mb-2">Provider</label>
              ...
              <div>
                ...
                <p className="text-white/20 text-[10px] mt-1.5">
                  Your key stays on your machine and is never stored or sent to AgentWatch servers.
                </p>
              </div>
            </motion.div>
          )}
